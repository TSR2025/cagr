import { normalizeTimeState } from "../utils/timeModel";
...
export function calculateProjection(inputs: Inputs): ProjectionResult {
  ...
  const { startingAge: sanitizedStart, contributionEndAge: sanitizedEnd, projectionEndAge, totalYears, contributionYears } =
    normalizeTimeState(startingAge, contributionEndAge);
  ...
  return {
    ...
    contributionEndAge: sanitizedEnd,
    projectionEndAge,
    totalYears,
    contributionYears
  };
